...
# > Created Time: Wednesday, May 18, 2016 PM03:54:05 HKT
...
class Spider_Model:
    ...
    def GetPage(self,page):
        myUrl = "http://www.qiushibaike.com/textnew/page/" + page + "/?s=4878530"
    ...
    def ShowPage(self,nowPage,page):
        for items in nowPage:
            ...
            myInput = raw_input()
            ret = re.match('q',myInput)
            if ret:
                if 'q' == ret.group():
                    self.enable = False
                    print 'qiubai spider exit'
